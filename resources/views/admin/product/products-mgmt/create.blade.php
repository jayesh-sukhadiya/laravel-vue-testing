          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4>Add Product <small>(Product can be managed from here)</small></h4>
              ...
              <div class="card-body">
                <!--------- Begin Form  --------->
                <form class="form-horizontal" role="form" method="POST" action="{{ url('store-products') }}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  ...
                  <div class="row">
                    <div class="col-12 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pod_pro_name" id="pod_pro_name" placeholder="Product Title" value="{{ old('pod_pro_name') }}" required maxlength="200">
                    ...
                    <div class="col-12 col-md-3">
                      <div class="form-group">
                        ...
                        <select name="pod_cat_id" id="pod_cat_id" class="form-control pod_cat_id" required="">
                          ...
                          <option value="{{ $category->pro_id }}">{{ $category->pro_category_name}}</option>
                          @endforeach
                        </select>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here product description..."></textarea>
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                     <div class="col-12 col-md-6">
                      <div class="form-group">
                        <label>Product Picture<span class="require-star">*</span></label>
                   ...
                   <div class="row bordr-top">
                    <div class="col-12 text-center mt-3">
                      <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Save</button> <a href="{{ url('products') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                    </div>
                  </div>
                </form>
              </div>
