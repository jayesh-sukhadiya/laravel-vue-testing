...
<head>
  ...
  <title>Update Product - Ready Shopping</title>
  <!--------- Begin Css Style --------->
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Update Product <small>(Product can be managed from here)</small></h4>
                  ...
                  <div class="card-body">
                    ...
                    <!--------- Begin Form  --------->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('update-products') }}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6">
                          <div class="form-group">
                            <label>Product Title<span class="require-star">*</span></label>
                            <input type="text" class="form-control" name="pod_pro_name" id="pod_pro_name" placeholder="Product Title" value="{{ $editData->pod_pro_name }}" required maxlength="200">
                      ...
                      <div class="row">
                        <div class="col-12 col-md-3">
                          <div class="form-group">
                            ...
                            <select class="form-control selectric" name="pod_main_cat_id" id="pod_main_cat_id" required>
                              @foreach($mainCategorys as $category)
                              <option value="{{ $category->mac_id }}" @if($category->mac_id == $editData->pod_main_cat_id) selected="true" @endif>{{ $category->mac_title}}</option>
                              @endforeach
                            </select>
                             @if($errors->has('pod_main_cat_id')) <span class="help-block">
                                <strong>{{ $errors->first('pod_main_cat_id') }}</strong>
                                </span> 
                            @endif
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group">
                            <label>Product Discription<span class="require-star">*</span></label>
                            <textarea class="form-control" name="pod_pro_description" id="pod_pro_description" placeholder="Write here product description...">{{ $editData->pod_pro_description }}</textarea>
                      ...
                      <a href="{{ asset('public/assets/img/products/'.$editData->pod_picture) }}" target="_blank">Product Picture</a>
                       <div class="row bordr-top">
                        <div class="col-12 text-center mt-3">
                          <button type="submit" class="btn btn-icon icon-left btn-primary"><i class="far fa-save"></i> Update</button> <a href="{{ url('products') }}" class="btn btn-icon icon-left btn-secondary ml-2"><i class="fas fa-times"></i> Cancel</a>
                        </div>
                      </div>
                    </form>
                  </div>
